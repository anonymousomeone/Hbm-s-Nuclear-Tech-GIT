...
public class RenderMissileDummy extends Render<EntityMissileDummy> {

    public static final IRenderFactory<EntityMissileDummy> FACTORY = (RenderManager man) -> {return new RenderMissileDummy(man);};

    protected RenderMissileDummy(RenderManager renderManager) {
        super(renderManager);
    }

    @Override
    public void doRender(EntityMissileDummy missile, double x, double y, double z, float entityYaw, float partialTicks) {
        GL11.glPushMatrix();
    ...
    @Override
    protected ResourceLocation getEntityTexture(EntityMissileDummy entity) {
